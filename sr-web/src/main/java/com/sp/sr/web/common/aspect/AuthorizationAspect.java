package com.sp.sr.web.common.aspect;
...
public class AuthorizationAspect {
    ...
    @Pointcut("execution(public * com.sp.sr.web.*.controller.*.*(..))" +
            "&& !execution(public * com.sp.sr.web.user.controller.AuthorizationController.*(..)) && !execution(public * com.sp.sr.web.user.controller.UserController.register(..))")
    public void verity() {
